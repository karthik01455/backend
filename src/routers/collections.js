...
collectionRouter.get('/contentId/:contentId',authenticateToken, collectionController.getCollectionByContentId);
...
collectionRouter.delete('/:id', authenticateToken,collectionController.deleteCollection);
